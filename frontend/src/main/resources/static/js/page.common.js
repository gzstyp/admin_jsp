...
;(function(){
    ...
    urlPrefix = domain;//获取页面是不需要添加的,只是在ajax请求接口时才需要添加
    window.AppKey = {
        ...
        control : '/main',/**跳转到后台中心;用法:AppKey.control*/
        sysError : '系统出现错误',
    ...
    window.layerFn = {
        ...
        /**POST请求远程数据,不带正在加载提示信息;layerFn.ajaxPost(url,params,succeed);*/
        ...
        /**GET请求远程数据,不带正在加载提示信息;layerFn.ajaxGet(url,params,succeed);*/
        ...
        handleClose : function(msg,code){
            ...
            top.layer.alert(msg,{title:'系统提示',move:false,btn:false});
        },
    ...
    $.ajaxPrefilter(function(options,originalOptions,jqXHR){
        ...
        /*if(options.method && options.method.toLowerCase() == 'post'){
            ...
            if(!options.data){
                ...
                if(!getQuersyString('ssid',options.data)){
